...
export class QrService {
   ...
   */
  async generateQR(eventId: string, baseUrl: string): Promise<string> {
    const url = this.getEventUrl(eventId, baseUrl);
  ...
  getEventUrl(eventId: string, baseUrl: string): string {
